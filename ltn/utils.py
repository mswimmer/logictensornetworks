...
def pred_equal_strict():
    ...
    # The model will return n truth values, where n is the number of
    # values on dimension 0 (the batch dimension).
...
class LogitsToPredicateModel(keras.Model):
    """
    ...
    def _restore_from_tensors(self, tensors):
